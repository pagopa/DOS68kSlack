...
3. Save the generated D2 diagrams in the `infra/diagrams/` folder with appropriate names that reflect the content of the diagrams (e.g., `slackbot.d2`, `cms.d2`, `chatbot.d2`, `auth.d2`).
